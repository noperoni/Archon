 ...
 * is the HK-47 head mark (`/hk47.svg`, same asset as the console
    ...
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" aria-hidden>
      <defs>
        <linearGradient id={gid} x1="2" y1="2" x2="30" y2="30" gradientUnits="userSpaceOnUse">
          <stop stopColor="#CE3028" />
          <stop offset="0.5" stopColor="#C27740" />
          <stop offset="1" stopColor="#D08C58" />
        </linearGradient>
      </defs>
      <circle cx="16" cy="16" r="15" stroke={`url(#${gid})`} strokeWidth="1.6" />
      <circle cx="16" cy="16" r="11.5" fill="var(--surface-elevated)" />
      <image href="/hk47.svg" x="8" y="8" width="16" height="16" />
    </svg>
  );
}
